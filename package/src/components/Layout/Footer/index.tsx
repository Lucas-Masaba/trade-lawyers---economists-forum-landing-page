          ...
          >
            ...
            >
              <motion.div
                ...
                transition={{ duration: 0.3 }}
              >
                <Link href='https://www.linkedin.com/company/trade-lawyers-and-economists-forum/about/?viewAsMember=true' target='_blank' className='inline-flex items-center justify-center w-12 h-12 rounded-full bg-white/20 hover:bg-white/30 transition-colors backdrop-blur-sm'>
              ...
              <motion.div
                ...
                transition={{ duration: 0.3 }}
              >
                <Link href='https://x.com/_tlef_' target='_blank' className='inline-flex items-center justify-center w-12 h-12 rounded-full bg-white/20 hover:bg-white/30 transition-colors backdrop-blur-sm'>
                  <svg className='w-6 h-6 text-white' fill='currentColor' viewBox='0 0 24 24'>
